    ...
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10">
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-row items-center">
          <div className="bg-yt-light-black font-semibold text-sm text-yt-white px-3.5 py-1.5 rounded-r-3xl border-l-2 border-yt-light-black hover:bg-yt-red rounded-md cursor-pointer">
            <h1>Akash Developer</h1>
          </div>
